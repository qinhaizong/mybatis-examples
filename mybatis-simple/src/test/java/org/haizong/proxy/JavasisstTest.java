...
public class JavasisstTest {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        factory.setSuperclass(JavasisstTest.class); // 设置父类
        ...
        JavasisstTest proxyObj = (JavasisstTest) factory.create(new Class[0], new Object[0], methodHandler);
        proxyObj.foo();
    }
}
